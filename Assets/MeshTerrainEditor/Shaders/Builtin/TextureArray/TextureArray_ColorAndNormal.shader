Shader "MTE/Surface/TextureArray_ColorAndNormal"
{
	Properties
	{
	...
	SubShader
	{
		...
		void MTE_BuiltinRP_TextureArrayCore_ColorAndNormal(Input i, out float3 OutAlbedo, out float3 OutNormal)
		{
		...
		{
			MTE_BuiltinRP_TextureArrayCore_ColorAndNormal(i, o.Albedo, o.Normal);
			o.Alpha = 1;
		}
