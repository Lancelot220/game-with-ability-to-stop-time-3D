Shader "MTE/Surface/TextureArray_ColorOnly"
{
	Properties
	{
	...
	SubShader
	{
		...
		void MTE_BuiltinRP_TextureArrayCore_ColorOnly(Input i, out float3 OutAlbedo)
		{
		...
		{
			MTE_BuiltinRP_TextureArrayCore_ColorOnly(i, o.Albedo);
			o.Alpha = 1;
		}
