...
Shader "MTE/URP/TextureArray_ColorOnly"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 WeightedBlend415( half4 Weight, float4 Layer1, float4 Layer2, float4 Layer3, float4 Layer4 )
			{
						 ...
						 ) : SV_Target
			{
				...
				float4 localGetMax4WeightLayers18 = ( float4( 0,0,0,0 ) );
				float2 uv_Control0 = IN.ase_texcoord7.xy * _Control0_ST.xy + _Control0_ST.zw;
				float4 Control018 = tex2D( _Control0, uv_Control0 );
				...
				#endif
				float4 Control118 = staticSwitch21;
				float2 uv_Control2 = IN.ase_texcoord7.xy * _Control2_ST.xy + _Control2_ST.zw;
				#ifdef _HasWeightMap2
				float4 staticSwitch30 = tex2D( _Control2, uv_Control2 );
				#else
				float4 staticSwitch30 = _Vector0;
				#endif
				float4 Control218 = staticSwitch30;
				float4 Weights18 = float4( 1,0,0,0 );
				float4 Indices18 = float4( 1,0,0,0 );
				{
				Max4WeightLayer(Control018, Control118, Control218, Weights18, Indices18);
				}
				float4 LayerWeights16 = Weights18;
				float4 Weight15 = LayerWeights16;
				...
				float4 break13 = Indices18;
				int layerIndex2_g76 = (int)break13.x;
				...
				float4 Layer115 = localSampleTextureArray2_g76;
				Texture2DArray array2_g77 =(Texture2DArray)_TextureArray0;
				SamplerState SS2_g77 =(SamplerState)sampler_TextureArray0;
				float textureSize2_g77 = _TextureArray0_TexelSize.z;
				int layerIndex2_g77 = (int)break13.y;
				...
				float4 Layer215 = localSampleTextureArray2_g77;
				...
				int layerIndex2_g78 = (int)break13.z;
				...
				float4 Layer315 = localSampleTextureArray2_g78;
				...
				int layerIndex2_g75 = (int)break13.w;
				...
				float4 Layer415 = localSampleTextureArray2_g75;
				float4 localWeightedBlend415 = WeightedBlend415( Weight15 , Layer115 , Layer215 , Layer315 , Layer415 );
				
				float3 Albedo = (localWeightedBlend415).xyz;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 break13 = Indices18;
				int layerIndex2_g76 = (int)break13.x;
				float2 uv2_g76 = IN.ase_texcoord2.xy;
				float4 localSampleTextureArray2_g76 = SampleTextureArray2_g76( array2_g76 , SS2_g76 , textureSize2_g76 , layerIndex2_g76 , uv2_g76 );
				float4 Layer115 = localSampleTextureArray2_g76;
				Texture2DArray array2_g77 =(Texture2DArray)_TextureArray0;
				SamplerState SS2_g77 =(SamplerState)sampler_TextureArray0;
				float textureSize2_g77 = _TextureArray0_TexelSize.z;
				int layerIndex2_g77 = (int)break13.y;
				float2 uv2_g77 = IN.ase_texcoord2.xy;
				float4 localSampleTextureArray2_g77 = SampleTextureArray2_g77( array2_g77 , SS2_g77 , textureSize2_g77 , layerIndex2_g77 , uv2_g77 );
				float4 Layer215 = localSampleTextureArray2_g77;
				Texture2DArray array2_g78 =(Texture2DArray)_TextureArray0;
				SamplerState SS2_g78 =(SamplerState)sampler_TextureArray0;
				float textureSize2_g78 = _TextureArray0_TexelSize.z;
				int layerIndex2_g78 = (int)break13.z;
				float2 uv2_g78 = IN.ase_texcoord2.xy;
				float4 localSampleTextureArray2_g78 = SampleTextureArray2_g78( array2_g78 , SS2_g78 , textureSize2_g78 , layerIndex2_g78 , uv2_g78 );
				float4 Layer315 = localSampleTextureArray2_g78;
				Texture2DArray array2_g75 =(Texture2DArray)_TextureArray0;
				SamplerState SS2_g75 =(SamplerState)sampler_TextureArray0;
				float textureSize2_g75 = _TextureArray0_TexelSize.z;
				int layerIndex2_g75 = (int)break13.w;
				float2 uv2_g75 = IN.ase_texcoord2.xy;
				float4 localSampleTextureArray2_g75 = SampleTextureArray2_g75( array2_g75 , SS2_g75 , textureSize2_g75 , layerIndex2_g75 , uv2_g75 );
				float4 Layer415 = localSampleTextureArray2_g75;
				float4 localWeightedBlend415 = WeightedBlend415( Weight15 , Layer115 , Layer215 , Layer315 , Layer415 );
...
/*ASEBEGIN
Version=18935
71.33334;130;2428;1119;1934.508;279.3492;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;10;-3448.127,-78.15575;Inherit;False;1921.144;659.1725;;15;30;29;28;27;26;25;24;23;22;21;19;18;17;16;13;Fetch max 4 weighted layers;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;29;-3426.127,166.3047;Float;True;Property;_Control1;Control1;3;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;28;-3420.825,370.6815;Float;True;Property;_Control2;Control2;4;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;26;-3174.927,231.842;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;17;-3423.825,-18.15576;Float;True;Property;_Control0;Control0;2;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;27;-3169.624,436.2187;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;24;-2629.185,211.2272;Inherit;False;Constant;_Vector0;Vector 0;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;23;-2910.152,373.4214;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;25;-2915.454,169.0446;Inherit;True;Property;_ControlEx;ControlEx;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;22;-3169.625,49.38131;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;21;-2434.643,141.0452;Inherit;False;Property;_HasWeightMap1;HasWeightMap1;7;0;Create;True;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SamplerNode;19;-2922.258,-15.63983;Inherit;True;Property;_TextureSample4;Texture Sample 4;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;30;-2433.041,248.0289;Inherit;False;Property;_HasWeightMap2;HasWeightMap2;7;0;Create;True;0;0;0;False;0;False;0;0;0;False;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.CustomExpressionNode;18;-2174.605,57.26816;Inherit;False;Max4WeightLayer(Control0, Control1, Control2, Weights, Indices)@;7;Create;5;True;Control0;FLOAT4;1,0,0,0;In;;Inherit;False;True;Control1;FLOAT4;0,0,0,0;In;;Inherit;False;True;Control2;FLOAT4;0,0,0,0;In;;Inherit;False;True;Weights;FLOAT4;1,0,0,0;Out;;Half;False;True;Indices;FLOAT4;1,0,0,0;Out;;Half;False;GetMax4WeightLayers;False;False;0;;False;6;0;FLOAT4;0,0,0,0;False;1;FLOAT4;1,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;1,0,0,0;False;5;FLOAT4;1,0,0,0;False;3;FLOAT4;0;FLOAT4;5;FLOAT4;6
Node;AmplifyShaderEditor.BreakToComponentsNode;13;-1939.077,143.4741;Inherit;False;FLOAT4;1;0;FLOAT4;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.FunctionNode;40;-1472,96;Inherit;False;MTE_URP_SampleTextureArray0;0;;76;e7a93ea08c04a704c86a4e1babe66805;0;1;7;INT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;16;-1914.833,28.22095;Inherit;False;LayerWeights;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;41;-1472,192;Inherit;False;MTE_URP_SampleTextureArray0;0;;77;e7a93ea08c04a704c86a4e1babe66805;0;1;7;INT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;43;-1472,288;Inherit;False;MTE_URP_SampleTextureArray0;0;;78;e7a93ea08c04a704c86a4e1babe66805;0;1;7;INT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;42;-1472,384;Inherit;False;MTE_URP_SampleTextureArray0;0;;75;e7a93ea08c04a704c86a4e1babe66805;0;1;7;INT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.CommentaryNode;32;-2103.653,614.84;Inherit;False;574.452;237.46;;3;36;33;34;Texture UV Scales;1,1,1,1;0;0
Node;AmplifyShaderEditor.CustomExpressionNode;15;-1062.056,27.76177;Float;False;return Layer1 * Weight.r + Layer2 * Weight.g + Layer3 * Weight.b + Layer4 * Weight.a@;4;Create;5;True;Weight;FLOAT4;0,0,0,0;In;float[5];Half;False;True;Layer1;FLOAT4;0,0,0,0;In;;Float;False;True;Layer2;FLOAT4;0,0,0,0;In;;Float;False;True;Layer3;FLOAT4;0,0,0,0;In;;Float;False;True;Layer4;FLOAT4;0,0,0,0;In;;Float;False;Weighted Blend 4;True;False;0;;False;5;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-873.5081,99.1508;Inherit;False;Property;_Metallic;Metallic;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;14;-844.2164,22.37461;Inherit;False;True;True;True;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GlobalArrayNode;34;-2063.806,745.2745;Inherit;False;LayerUVScales;0;12;0;False;False;0;1;True;Object;-1;4;0;INT;0;False;2;INT;0;False;1;INT;0;False;3;INT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-2079.811,663.7614;Inherit;False;Property;_UVScale;UV Scale;6;0;Create;True;0;0;0;True;0;False;1;3.3;0.01;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;36;-1805.513,704.217;Inherit;False;Property;ENABLE_LAYER_UV_SCALE;Enable per-layer UV Scale;5;0;Create;False;0;0;0;True;0;False;0;0;0;True;ENABLE_LAYER_UV_SCALE;Toggle;2;Key0;Key1;Create;False;False;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-871.5081,180.6508;Inherit;False;Property;_Smoothness;Smoothness;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-332.1152,9.536743E-07;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;13;0;18;6
WireConnection;40;7;13;0
WireConnection;16;0;18;5
WireConnection;41;7;13;1
WireConnection;43;7;13;2
WireConnection;42;7;13;3
WireConnection;15;0;16;0
WireConnection;15;1;40;0
WireConnection;15;2;41;0
WireConnection;15;3;43;0
WireConnection;15;4;42;0
WireConnection;14;0;15;0
WireConnection;1;0;14;0
WireConnection;1;3;45;0
WireConnection;1;4;46;0
ASEEND*/
//CHKSM=360911ED8E1148B7949CFEF4A8F69900D2CFDEBA