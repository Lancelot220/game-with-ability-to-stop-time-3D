...
namespace MTE
{
    ...
    internal class SplatPainter : IEditor
    {
        ...
        private void LoadSavedParamter()
        {
            ...
            brushDirection = EditorPrefs.GetFloat($"MTE_SplatPainter.brushDirection", DefaultBrushDirection);
        }
        
        private GameObject targetGameObject { get; set; }
        private Mesh targetMesh { get; set; }
        private MeshCollider targetMeshCollider { get; set; }
        private MeshRenderer targetMeshRenderer { get; set; }
        ...
        private void BuildEditingInfoForLegacyMode(GameObject gameObject)
        {
            ...
            this.targetMeshRenderer = meshRenderer;
            this.targetMeshCollider = meshCollider;
        ...
        public void OnSceneGUI()
        {
            ...
            if (PainterMode == EditorFilterMode.SelectedGameObject)
            {
                if (!targetGameObject || !targetMeshCollider || !targetMaterial || !targetMesh)
                {
                    return;
                }

                if (!targetMeshCollider.Raycast(ray, out raycastHit, Mathf.Infinity))
                {
                    return;
                }
                ...
                var meshSize = targetMeshRenderer.bounds.size.x;
